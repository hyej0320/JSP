...
public class ForwardServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
		...
		// 원래는 PrintWriter를 꺼내서 HTML코드를 입력해야 하지만
		// HTML코드를 입력하는 부분을 포워드를 통해 다른 .jsp로 넘겨줄 수 있다
		
		// 포워드 시에 사용하는 경로는 webapp밑의 폴더 내부 경로를 사용한다
		...
		// 포워드 시 현재 서블릿에서 사용하던 요청, 응답 객체를 그대로 전달해준다
